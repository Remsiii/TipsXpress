...
const page = () => {
  return (
    <section class="flex items-center bg-stone-500 l:h-screen font-poppins dark:bg-gray-800 rounded">
    <div class="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
        <div class="flex flex-wrap items-center ">
            ...
            <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                <div class="flex mb-4">
                    <span
                        class="flex items-center justify-center flex-shrink-0 w-12 h-12 mr-6 bg-yellow-500 rounded dark:bg-yellow-500 dark:text-gray-100 text-gray-50">
